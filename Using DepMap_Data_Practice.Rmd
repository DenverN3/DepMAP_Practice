...
#Had to force the installation through Bioconductor using the command Force = True
```
...
```{r}
# Laod RNAi and CRISPR and CopyNumber datasets for visualization. Use data frm 19Q3 release
eh <- ExperimentHub()
query(eh, "depmap")
```
...
```{r}
#Plot histogram of dependency scores
